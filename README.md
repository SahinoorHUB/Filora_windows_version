...
Official Windows builds of [Filora](https://filora-two.vercel.app).
...
1. Download the `.7z` archive for your version.
2. Extract the archive (Windows 10/11 built-in support, or [7-Zip](https://www.7-zip.org/)).
3. Run `Filora.exe`.
